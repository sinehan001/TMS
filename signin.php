...
<head>
	...
	<body data-kt-name="Marketino" id="kt_body" class="app-blank app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			<style>body { background-image: url('./manager/assets/media/auth/bg4.jpg'); } [data-theme="dark"] body { background-image: url('./manager/assets/media/auth/bg4-dark.jpg'); }</style>
			<div class="d-flex flex-column flex-column-fluid flex-lg-row">
				<div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
					<div class="d-flex flex-column align-items-center">
						<a href="./index.php" class="mb-7">
							<img alt="Logo" src="./manager/assets/media/logos/logo-small1.png" width="80%" style="display: table; margin: 0 auto;" />
						</a>
				...
				<div class="d-flex flex-center w-lg-50 p-10">
					<div class="card rounded-3 w-md-550px">
						<div class="card-body p-10 p-lg-20">
							<form class="form w-100" id="signin" method="POST" action="signin_auth.php" autocomplete="off">
								...
								<div class="d-grid">
									<input type="submit" name="submit" id="kt_sign_in_submit" class="btn btn-primary" value="Sign In" />
								</div>
							</form>
						</div>
					</div>
	...
	<script src="./manager/assets/js/custom/authentication/sign-in/general.js"></script>
