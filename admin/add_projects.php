								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<li class="breadcrumb-item text-muted">Add Projects</li>
										</ul>
									</div>
								</div>
							</div>
									...
									<div class="card mb-5 mb-xl-8">
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold fs-3 mb-1">Add Projects</span>
												<span class="text-muted mt-1 fw-semibold fs-7">One Project can add at a time</span>
											</h3>
										</div>
                                        <div class="card-body py-md-4">
                        					<form _lpchecked="1" method="POST" action="update_projects.php" enctype='multipart/form-data'>
                                                ...
                                                <div class="form-group">
                                                    <select  name="experience" class="form-select form-select-solid" id="floatingSelect1" aria-label="Floating label select example" required>
                                                        <option value="">Select Project Experience Level</option>
                                                ...
                                                <div class="form-group">
                                                    <input type="number" class="form-control" id="name" name="duration" placeholder="Project Duration (in Days)" required />
                                                </div>
                        					    <div class="d-flex flex-row align-items-center justify-content-center mt-8">
                        					        <input class="btn btn-primary" type="submit" name="submit" value="Add Project">
                        					    </div>
                        					    <!-- <div class="form-group">
                        					    ...
                        					    <div class="d-flex flex-row align-items-center justify-content-center mt-8">
                        					        <input class="btn btn-primary" type="submit" name="submit" value="Create Staff">
                        					    </div> -->
                        					</form>
                                        </div>
									</div>
