...
<head>
		...
		<meta property="og:title" content="Marketino - Bootstrap 5 HTML, VueJS, React, Angular, Asp.Net Core, Blazor, Django, Flask &amp; Laravel Admin Dashboard Theme" />
		<meta property="og:url" content="#/Marketino" />
		<meta property="og:site_name" content="Marketino | Marketino" />
		<link rel="canonical" href="https://preview.Marketino.com/Marketino8" />
		...
		<link rel="stylesheet" type="text/css" media="screen" href="../manager/assets/css/global.css" />
        <style>
            .paginate_button {
                padding: 8px;
                cursor: pointer;
			...
			.upload-console [data-theme=dark] {
				--kt-app-bg-color: #151521 !important;
				--kt-app-blank-bg-color: #151521 !important;
				--kt-app-header-base-bg-color: #1e1e2d !important;
				--kt-app-header-base-bg-color-mobile: #1e1e2d !important;
				--kt-app-header-base-box-shadow: none !important;
				--kt-app-header-base-box-shadow-mobile: none !important;
				--kt-app-toolbar-base-bg-color: #1a1a27 !important;
				--kt-app-toolbar-base-bg-color-mobile: #1a1a27 !important;
				--kt-app-toolbar-base-box-shadow: none !important;
				--kt-app-toolbar-base-box-shadow-mobile: 0px 10px 30px 0px rgba(82, 63, 105, 0.05) !important;
				--kt-app-toolbar-base-border-top: 0 !important;
				--kt-app-toolbar-base-border-top-mobile: 1px solid #eff2f5 !important;
				--kt-app-footer-bg-color: #1e1e2d !important;
				--kt-app-footer-bg-color-mobile: #1e1e2d !important;
			}
	...
	<body data-kt-name="Marketino" id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
						...
						<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
							<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
								<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										<span class="menu-link" onclick="window.location.href='manager.php'">
											<span class="menu-icon">
												<span class="svg-icon svg-icon-2">
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										<span class="menu-link" onclick="window.location.href='staffs.php'">
											<span class="menu-icon">
												<span class="svg-icon svg-icon-2">
												<svg clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="white">
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										<span class="menu-link" onclick="window.location.href='projects.php'">
											<span class="menu-icon">
												<span class="svg-icon svg-icon-2">
												<svg clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="white">
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										<span class="menu-link" onclick="window.location.href='add_managers.php'">
											<span class="menu-icon">
												<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: white;" alt="">
											...
											<span class="menu-title">Add Managers</span>
										</span>
									</div>
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										<span class="menu-link" onclick="window.location.href='add_staffs.php'">
											<span class="menu-icon">
												<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: white;" alt="">
                                                    <path d="M19.5 15c-2.483 0-4.5 2.015-4.5 4.5s2.017 4.5 4.5 4.5 4.5-2.015 4.5-4.5-2.017-4.5-4.5-4.5zm2.5 5h-2v2h-1v-2h-2v-1h2v-2h1v2h2v1zm-7.18 4h-14.815l-.005-1.241c0-2.52.199-3.975 3.178-4.663 3.365-.777 6.688-1.473 5.09-4.418-4.733-8.729-1.35-13.678 3.732-13.678 6.751 0 7.506 7.595 3.64 13.679-1.292 2.031-2.64 3.63-2.64 5.821 0 1.747.696 3.331 1.82 4.5z"/>
						...
						<div class="d-flex flex-column flex-column-fluid">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<li class="breadcrumb-item text-muted">Add Staffs</li>
										</ul>
									</div>
								</div>
							</div>
									...
									<!-- <div class="card mb-5 mb-xl-8"> -->
										<!-- <div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold fs-3 mb-1">Add Staffs</span>
												<span class="text-muted mt-1 fw-semibold fs-7">One Staff can add at a time</span>
											</h3>
										</div> -->
										<div id="kt_app_content_container" class="app-container  container-xxl ">
							...
							<div class="mb-5 hover-scroll-x">
    							<div class="d-grid">
    							    <ul class="nav nav-tabs flex-nowrap text-nowrap">
    							        <li class="nav-item">
    							            <a class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0 active" data-bs-toggle="tab" href="#kt_tab_pane_1">Add Staff</a>
    							        </li>
    							        <li class="nav-item">
    							            <a class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0" data-bs-toggle="tab" href="#kt_tab_pane_2">Edit Staff</a>
    							        </li>
    							        <li class="nav-item">
    							            <a class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0" data-bs-toggle="tab" href="#kt_tab_pane_3">Upload Bulk Staffs</a>
    							        </li>
    							    </ul>
    							</div>
							</div>
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									<div class="card mb-5 mb-xl-8">
                                        ...
                                        <div class="card-body py-md-4">
                        					<form _lpchecked="1" method="POST" action="update_staffs.php" enctype='multipart/form-data'>
                        					    ...
                        					    <div class="form-group" id="show_hide_password">
                        					        <input type="password" class="form-control" style="margin-bottom: 0px;" id="password" name="password" placeholder="Set Password" required>
                        					        <div class="input-group-addon float-right" style="margin-bottom: 1.3rem;">
                        					            <a href="" style="float: right; margin-top:5px; margin-bottom: 15px;">Show Password</a>
                        					        </div>
                        					    </div>       
                        					    <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <select  name="experience" class="form-select form-select-solid" id="floatingSelect1" aria-label="Floating label select example" required>
                                                ...
                                                <div class="form-group">
                                                    <select  name="designation" class="form-select form-select-solid" id="floatingSelect1" aria-label="Floating label select example" required>
                                                ...
                                                <div class="form-group">
                                                    <select  name="category" class="form-select form-select-solid" id="floatingSelect1" aria-label="Floating label select example" required>
                        					    ...
                        					    <div class="form-group input-group mb-3 px-2 py-2 border shadow-sm" style="border: 1px solid #323248 !important; border-radius: 10px;">
                        					        <input id="upload" type="file" name="image" accept="image/*" class="form-control border-0" />
                        					        <label id="upload-label" for="upload" class="font-weight-bold text-muted">Profile Image</label>
                        					        <div class="input-group-append">
                        					            <label for="upload" class="btn btn-light m-0 rounded-pill px-4"> <i class="fa fa-cloud-upload mr-2 text-muted"></i><small class="text-uppercase text-gray-700 font-weight-bold text-white"> Upload <i> </i></small></label>
                        					        </div>
                        					    </div>
                        					    <div class="d-flex flex-row align-items-center justify-content-center mt-8">
						    ...
						    <div class="console-wrapper">
                                <div class="upload-console">
                                    <h2 class="upload-console-header">Upload CSV files</h2>
                                    <div class="upload-console-body">
                                        <h3>Select files</h3>
                                        <form id="file_form" method="POST" enctype="multipart/form-data">
                                            <input type="file" name="files[]" id="standard-upload-file" accept="csv">
                                            <input type="submit" value="Upload file" id="standard-upload">
                                        </form>
										...
										<div>
                               				<a id="send_data" class="btn btn-primary">
												<i class="bi bi-send fs-4 me-2"></i>Send Data
											</a>
										</div>
                                    </div>
                                </div>
  	...
  	?>
		<script>var hostUrl = "../manager/assets/index.php";</script>
		...
		<script src="../manager/assets/js/upload.js"></script>
    	<script src="../manager/assets/js/global.js"></script>
		<?php
  		if(isset($_SESSION['error'])){
...
$(document).ready(function() {
    $("#show_hide_password a").on('click', function(event) {
        ...
        if($('#show_hide_password input').attr("type") == "text"){
            ...
            $('#show_hide_password a').html("Show Password");
        }else if($('#show_hide_password input').attr("type") == "password"){
            $('#show_hide_password input').attr('type', 'text');
            $('#show_hide_password a').html( "Hide Password" );
        }
    });
});
</script>
