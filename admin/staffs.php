								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<li class="breadcrumb-item text-muted">Manage Staffs</li>
										</ul>
									</div>
								</div>
							</div>
									...
									<div class="card mb-5 mb-xl-8">
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold fs-3 mb-1">Manage Staffs</span>
												...
												<table id="example" class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
													<thead>
														<tr class="fw-bold text-muted">
                                                            <th class="min-w-100px text-start">ID</th>
                                                            <th class="min-w-100px tex-start not-export-col">Image</th>
															<th class="min-w-150px text-start">Staff Name</th>
                                                            <th class="min-w-100px text-start">Email</th>
                                                            <th class="min-w-100px text-start">Phone No.</th>
                                                            <th class="min-w-100px text-start">Address</th>
															<th class="min-w-100px text-start">Designation</th>
															<th class="min-w-100px text-start">Category</th>
															<th class="min-w-100px text-start">Experience</th>
														</tr>
													</thead>
													<tbody>
                                                        <?php 
                                                        ...
                                                        if(mysqli_num_rows($query) > 0)
                                                        {
                                                            ...
                                                            {
																$arr = explode(',',$row['designation']);
																$count = count($arr)-1;
																$designation = "";
																for($i = 0;$i<$count;$i++) {
																	$designation .= $arr[$i]." | ";
																}
																$designation .= $arr[$count];
                                                                ...
                                                                <td class="text-start not-export-col"><img class=""image-fluid src="../manager/uploads/images/staffs/'.$row['image'].'" width="48px" height="48px"></td>
																...
																<td class="text-start">'.$row["exp"].'</td>
                                                                </tr>';
                                                            } 
                                                    }
                                                    else 
