								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<li class="breadcrumb-item text-muted">Manage Projects</li>
										</ul>
									</div>
								</div>
							</div>
									...
									<div class="card mb-5 mb-xl-8">
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold fs-3 mb-1">Manage Projects</span>
												<span class="text-muted mt-1 fw-semibold fs-7">Over 500 Projects</span>
											</h3>
										</div>
												...
												<table id="example" class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
													<thead>
														<tr class="fw-bold text-muted">
                                                            ...
                                                            <th class="min-w-150px text-center not-export-col">Project Name</th>
															<th class="min-w-100px text-center">Manager Name</th>
                                                            <th class="min-w-100px text-center">Total Staffs</th>
                                                            <th class="min-w-100px text-center">Modules</th>
                                                            <th class="min-w-100px text-center">Activity</th>
                                                            <th class="min-w-100px text-center">Progress</th>
                                                            <th class="min-w-100px text-center">Assigned Date</th>
                                                            <th class="min-w-100px text-center">Duration</th>
                                                            <th class="min-w-100px text-center">Experience</th>
														</tr>
													</thead>
													<tbody>
                                                        <?php 
                                                        ...
                                                        if(mysqli_num_rows($query) > 0)
                                                        {
                                                            ...
                                                            {
                                                                $manager = $row['manager'];
                                                                $q1 = "SELECT * FROM managers WHERE email = '$manager'";
                                                                $query2 = mysqli_query($conn, $q1);
                                                                $col = mysqli_fetch_assoc($query2);
                                                                $date = date('Y-m-d',$row['assign_date']);
                                                                $completed_activity = $row['completed_activity'];
                                                                $completed_modules = $row['completed_modules'];
																$total_activity_progress = 0;
																$row_activity = $row['activity'];
																$show_modules = 0;
																$show_activity = 0;
																if($row_activity!=NULL) {
																	$total_activity_progress = number_format(($completed_activity/$row_activity)*100,2,'.','');
																	$show_activity = $completed_activity."/".$row_activity;
																}
																else {
																	$row_activity = "N/A";
																	$show_activity = "N/A";
																}
																$row_modules = $row['modules'];
																if($row_modules==NULL) {
																	$row_modules = "N/A";
																	$show_modules = "N/A";
																}
																else {
																	$show_modules = $completed_modules."/".$row_modules;
																}
                                                                echo '<tr>
                                                                <td class="text-center">'.$row["id"].'</td>
                                                                <td class="text-center">'.$row["name"].'</td>
                                                                <td class="text-center">'.$col["name"].'</td>
                                                                <td class="text-center">'.$row["total_staffs"].'</td>
                                                                <td class="text-center">'.$show_modules.'</td>
                                                                <td class="text-center">'.$show_activity.'</td>
                                                                <td class="text-center">'.$total_activity_progress.'%</td>
  	...
  	?>
        ...
        jQuery(document).ready(function($) {
			...
			initComplete:function (  ) {
      			...
      			reversedHeaders.reverse();
      			reversedHeaders.push('');
      			ignorePositions.reverse();
    		},
            buttons: [
                    'copy',
                    'excel',
