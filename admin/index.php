						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div class="container d-flex flex-wrap align-items-center">
									...
									$query = mysqli_query($conn, "SELECT COUNT(*) as total FROM `managers`;"); 
									while($row = mysqli_fetch_assoc($query)) {
										$managers = $row['total'];
									}
									$query = mysqli_query($conn, "SELECT COUNT(*) as total FROM `staffs`;"); 
									while($row = mysqli_fetch_assoc($query)) {
										$staffs = $row['total'];
									}
									$query = mysqli_query($conn, "SELECT COUNT(*) as total FROM `projects` WHERE project_status=0;"); 
									while($row = mysqli_fetch_assoc($query)) {
										$not_started_projects = $row['total'];
									}
									$query = mysqli_query($conn, "SELECT COUNT(*) as total FROM `projects` WHERE project_status=1;"); 
									while($row = mysqli_fetch_assoc($query)) {
										$ongoing_projects = $row['total'];
									}
									$query = mysqli_query($conn, "SELECT COUNT(*) as total FROM `projects` WHERE project_status=2;"); 
									while($row = mysqli_fetch_assoc($query)) {
										$completed_projects = $row['total'];
									}
									?>
									<div class="m-6 col-md-3 card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end mb-5 mb-xl-10" style="background-color: #415af1;">
										<div class="card-header pt-5">
											<div class="card-title d-flex flex-column">
												<span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2"><?php echo $managers; ?></span>
												<span class="text-white opacity-75 pt-1 fw-semibold fs-6">Total Managers</span>
											</div>
											<div class="card-body card-support d-flex justify-content-center pt-0">
												<i class="fas fa-user" style="font-size: 50px; color: white;"></i>
											</div>
										</div>
									</div>
									<div class="m-6 col-md-3 card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end mb-5 mb-xl-10" style="background-color: #e70e43;">
										<div class="card-header pt-5">
											<div class="card-title d-flex flex-column">
												<span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2"><?php echo $staffs; ?></span>
												<span class="text-white opacity-75 pt-1 fw-semibold fs-6">Total Staffs</span>
											</div>
											<div class="card-body card-support d-flex justify-content-center pt-0">
												<i class="fas fa-hourglass" style="font-size: 50px; color: white;"></i>
											</div>
										</div>
									</div>
									<div class="m-6 col-md-3 card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end mb-5 mb-xl-10" style="background-color: #ca6e0b;">
										<div class="card-header pt-5">
											<div class="card-title d-flex flex-column">
												<span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2"><?php echo ($ongoing_projects+$completed_projects+$not_started_projects); ?></span>
												<span class="text-white opacity-75 pt-1 fw-semibold fs-6">Total Projects</span>
											</div>
											<div class="card-body card-support d-flex justify-content-center pt-0">
									...
									<div class="m-6 col-md-3 card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end mb-5 mb-xl-10" style="background-color: #9AA899;">
										<div class="card-header pt-5">
											<div class="card-title d-flex flex-column">
												<span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2"><?php echo $completed_projects; ?></span>
									...
									<div class="m-6 col-md-3 card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end mb-5 mb-xl-10" style="background-color: #46c323;">
										<div class="card-header pt-5">
											<div class="card-title d-flex flex-column">
												<span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2"><?php echo $ongoing_projects; ?></span>
												<span class="text-white opacity-75 pt-1 fw-semibold fs-6">Ongoing Projects</span>
											</div>
											<div class="card-body card-support d-flex justify-content-center pt-0">
												<i class="fas fa-check-circle" style="font-size: 50px; color: white;"></i>
											</div>
									...
									<div class="m-6 col-md-3 card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end mb-5 mb-xl-10" style="background-color: #38AFCD;">
										<div class="card-header pt-5">
											<div class="card-title d-flex flex-column">
												<span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2"><?php echo $not_started_projects; ?></span>
												<span class="text-white opacity-75 pt-1 fw-semibold fs-6">Abundant Projects</span>
											</div>
											<div class="card-body card-support d-flex justify-content-center pt-0">
												<i class="fas fa-user" style="font-size: 50px; color: white;"></i>
											</div>
