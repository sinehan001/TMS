								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<li class="breadcrumb-item text-muted">Add Managers</li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="mb-5 hover-scroll-x">
    							<div class="d-grid">
    							    <ul class="nav nav-tabs flex-nowrap text-nowrap">
    							        <li class="nav-item">
    							            <a class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0 active" data-bs-toggle="tab" href="#kt_tab_pane_1">Add Manager</a>
    							        </li>
    							        <li class="nav-item">
    							            <a class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0" data-bs-toggle="tab" href="#kt_tab_pane_2">Edit Manager</a>
    							        </li>
    							        <li class="nav-item">
    							            <a class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0" data-bs-toggle="tab" href="#kt_tab_pane_3">Upload Bulk Managers</a>
    							        </li>
    							    </ul>
    							</div>
							</div>
									...
									<div class="card mb-5 mb-xl-8">
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold fs-3 mb-1">Add Managers</span>
												<span class="text-muted mt-1 fw-semibold fs-7">One Manager can add at a time</span>
											</h3>
										</div>
                                        <div class="card-body py-md-4">
                        					<form _lpchecked="1" method="POST" action="update_managers.php" enctype='multipart/form-data'>
						    ...
						    <div class="console-wrapper">
                                <div class="upload-console">
                                    ...
                                    <div class="upload-console-body">
										...
										<div>
                               				<a id="send_data_man" class="btn btn-primary">
