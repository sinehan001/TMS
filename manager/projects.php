									...
									<div class="card mb-5 mb-xl-8">
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold fs-3 mb-1">Assigned Projects</span>
												<span class="text-muted mt-1 fw-semibold fs-7">Over 500 projects</span>
											</h3>
                                            <div class="justify-content-center pt-3">
                                                <a id="add-module-btn" class="btn btn-primary">Add Modules</a>
                                            </div>
										</div>
										<div class="card-body py-3" id="card-body">
										</div>
									</div>
								</div>
							</div>
