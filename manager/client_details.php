								...
								<form action="update.php" method="POST" enctype="multipart/form-data">
									...
									<?php 
										...
										if(!isset($_GET['address'])) {
											...
											$query = mysqli_query($conn, "SELECT DISTINCT c.name, c.address, c.phone, c.email, c.city, a.staffs , a.call_status, a.whatsapp_status, a.email_status, a.notes, a.status FROM clients as c INNER JOIN admin_table as a ON a.address = c.address WHERE c.address LIKE '$address%';");
											while($row = mysqli_fetch_assoc($query)) {
												...
												$provider = $split[2];
									?>
										<div class="image-input image-input-empty" data-kt-image-input="true" style="background-image: url(./uploads/images/client.svg); background-size: contain;">
