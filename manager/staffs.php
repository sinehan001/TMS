											...
											<div class="table-responsive">
												<table id="example" class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
													...
													<tbody>
                                                        ...
                                                        $sql = "SELECT * FROM staffs WHERE memail='$memail'";
                                                        ...
                                                        if(mysqli_num_rows($query) > 0)
                                                        {
                                                            while($row = mysqli_fetch_assoc($query))
                                                            {
                                                                ...
                                                                <td class="text-start not-export-col"><img class=""image-fluid src="uploads/images/staffs/'.$row['image'].'" width="48px" height="48px"></td>
