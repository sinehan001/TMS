            ...
            if(!is_null($filename)) {
                ...
                try{
                    if(move_uploaded_file($temp, $destFolder . $newFile)) {
                        $query = "INSERT INTO staffs (name, address, password, email, phone, image, memail) VALUES ('$name','$address','$hashp04','$email','$phone','$newFile','$memail')";
                ...
                // echo "not full";
                $query = "INSERT INTO staffs (name, address, password, email, phone, image, memail) VALUES ('$name','$address','$hashp04','$email','$phone','client.svg','$memail')";
                mysqli_query($conn, $query);
