					...
					<div class="app-container container-fluid d-flex align-items-stretch justify-content-between">
						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
							<a href="index.php" class="d-lg-none">
								<img alt="Logo" src="assets/media/logos/logo-small.png" class="h-30px" />
							</a>
						</div>
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
						<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
							<a href="index.php">
								<img alt="Logo" src="assets/media/logos/logo2.png" class="h-36px app-sidebar-logo-default" />
						...
						<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
							<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
								<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										<span class="menu-link" onclick="window.location.href='upload.php'">
											<span class="menu-icon">
												<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: white;">
						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div class="container d-flex flex-wrap align-items-center">
											<div class="m-6 col-md-3 col-xl-3 card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-80 mb-5 mb-xl-10" style="background-color: #e70e43;">
												<div class="card-header pt-5">
													<div class="card-title d-flex flex-column">
													<?php include 'conn.php'; $manager = $_SESSION['email']; $query = mysqli_query($conn, "SELECT COUNT(*) as total FROM staffs WHERE memail='$manager'"); $row = mysqli_fetch_assoc($query); ?>
														<span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2"><?php echo $row['total']; ?></span>
											...
											$progress = 0;
											$none = 0;
											// $query = mysqli_query($conn, "SELECT status, COUNT(*) as total FROM `admin_table` GROUP BY status;"); 
											...
											<div class="m-6 col-md-3 card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end mb-5 mb-xl-10" style="background-color: #415af1;">
												<div class="card-header pt-5">
													<div class="card-title d-flex flex-column">
														<span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2"><?php echo $progress; ?></span>
											...
											<div class="m-6 col-md-3 card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end mb-5 mb-xl-10" style="background-color: #46c323;">
												<div class="card-header pt-5">
													<div class="card-title d-flex flex-column">
														<span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2"><?php echo $completed; ?></span>
											...
											<div class="m-6 col-md-3 card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end mb-5 mb-xl-10" style="background-color: #d241f1;">
												<div class="card-header pt-5">
													<div class="card-title d-flex flex-column">
														<span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2"><?php echo $pending; ?></span>
														<span class="text-white opacity-75 pt-1 fw-semibold fs-6">Pending</span>
													</div>
													<div class="card-body card-support d-flex justify-content-center pt-0">
														<i class="fas fa-exclamation-triangle" style="font-size: 50px; color: white;"></i>
													</div>
												</div>
											</div>
											<div class="m-6 col-md-3 card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end mb-5 mb-xl-10" style="background-color: #ca6e0b;">
												<div class="card-header pt-5">
													<div class="card-title d-flex flex-column">
														<span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2"><?php echo $none; ?></span>
														<span class="text-white opacity-75 pt-1 fw-semibold fs-6">None</span>
													</div>
													<div class="card-body card-support d-flex justify-content-center pt-0">
														<i class="fas fa-times-circle" style="font-size: 50px; color: white;"></i>
													</div>
												</div>
											</div>
								</div>
												...
												<div class="card-header pt-5 mb-6">
													<h3 class="card-title align-items-start flex-column">
														<div class="d-flex align-items-center mb-2">
															<span class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2">Task Analytics</span>
														</div>
														<span class="fs-6 fw-semibold text-gray-400">Average Performace Chart</span>
													</h3>
